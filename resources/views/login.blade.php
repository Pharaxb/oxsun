    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" value="{{ old('email') }}" placeholder="email@example.com" dir="ltr" required>
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" placeholder="********" dir="ltr" required>
        ...
        {{--<p class="text-center mt-4 mb-0">
            حساب کاربری ندارید؟ <a href="#" class="text-decoration-none">ثبت نام کنید</a>
        </p>--}}
    </div>
</div>
</body>
